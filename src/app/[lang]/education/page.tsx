					...
					<Grid container spacing={3}>
							...
							<Card>
								...
								<CardContent>
									...
									<Typography variant='body2' color='text.secondary' paragraph>
										Программы обучения в области информационных технологий,
										включая программирование, базы данных, сети и информационную
										безопасность.
									</Typography>
									<Button
										variant='outlined'
										component={Link}
										href={`/${lang}/education/programs/it`}
									>
										{t.learnMore}
									</Button>
								</CardContent>
						...
						<Grid size={4}>
							<Card>
								...
								<CardContent>
									...
									<Typography variant='body2' color='text.secondary' paragraph>
										Программы обучения в области экономики, включая
										макроэкономику, микроэкономику, финансы и бухгалтерский
										учет.
									</Typography>
									<Button
										variant='outlined'
										component={Link}
										href={`/${lang}/education/programs/economics`}
									>
										{t.learnMore}
									</Button>
								</CardContent>
						...
						<Grid size={4}>
							<Card>
								...
								>
									<Image
										src='/program-languages.jpg'
										alt='Иностранные языки'
										fill
										style={{ objectFit: 'cover' }}
									/>
								</CardMedia>
								<CardContent>
									...
									<Typography variant='body2' color='text.secondary' paragraph>
										Программы обучения иностранным языкам, включая английский,
										немецкий, французский, китайский и другие языки.
									</Typography>
									<Button
										variant='outlined'
										component={Link}
										href={`/${lang}/education/programs/languages`}
									>
										{t.learnMore}
									</Button>
								</CardContent>
